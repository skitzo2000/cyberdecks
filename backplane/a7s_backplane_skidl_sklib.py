...
a7s_backplane_skidl = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'Conn_02x15_Odd_Even', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'Conn_02x15_Odd_Even'}), 'ref_prefix':'J', 'fplist':[''], 'footprint':'Connector_PinSocket_2.54mm:PinSocket_2x15_P2.54mm_Vertical', 'keywords':'connector', 'description':'Generic connector, double row, 02x15, odd/even pin numbering scheme (row 1 odd numbers, row 2 even numbers), script generated (kicad-library-utils/schlib/autogen/connector/)', 'datasheet':'', 'pins':[
            ...
            Pin(num='30',name='Pin_30',func=pin_types.PASSIVE,unit=1)], 'unit_defs':[] }),
        Part(**{ 'name':'Conn_01x15', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'Conn_01x15'}), 'ref_prefix':'J', 'fplist':[''], 'footprint':'Connector_PinSocket_2.54mm:PinSocket_1x15_P2.54mm_Vertical', 'keywords':'connector', 'description':'Generic connector, single row, 01x15, script generated (kicad-library-utils/schlib/autogen/connector/)', 'datasheet':'', 'pins':[
            ...
            Pin(num='13',name='Pin_13',func=pin_types.PASSIVE,unit=1),
            Pin(num='14',name='Pin_14',func=pin_types.PASSIVE,unit=1),
            Pin(num='15',name='Pin_15',func=pin_types.PASSIVE,unit=1)], 'unit_defs':[] }),
        ...
        Part(**{ 'name':'Conn_01x18', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'Conn_01x18'}), 'ref_prefix':'J', 'fplist':[''], 'footprint':'a7s:FLIPPER-GPIO-18', 'keywords':'connector', 'description':'Generic connector, single row, 01x18, script generated (kicad-library-utils/schlib/autogen/connector/)', 'datasheet':'', 'pins':[
            ...
            Pin(num='16',name='Pin_16',func=pin_types.PASSIVE,unit=1),
            Pin(num='17',name='Pin_17',func=pin_types.PASSIVE,unit=1),
            Pin(num='18',name='Pin_18',func=pin_types.PASSIVE,unit=1)], 'unit_defs':[] }),
